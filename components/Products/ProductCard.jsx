...
function ProductCard({ name, image }) {
    return (
        <div className="flex flex-col justify-center items-center mx-auto my-8 hover:scale-110   transition-transform duration-300  cursor-pointer">
            ...
            <Image src={image} width={300} height={300} alt={image} className=" h-52 w-60 rounded-lg shadow-md bg-cover bg-center opacity-80 object-cover  hover:opacity-100 transition-transform duration-300 " />
