...
function Footer() {
    ...
    return (
        <div className='bg-slate-200 min-h-96  p-5 flex md:flex-row flex-col space-y-10  text-[#1c3e57] items-center justify-around font-mono '>
            ...
            <div className='space-y-5'>
                ...
                <ul className='space-y-4 text-sm'>
                    <li>
                        <b>Office Address:</b> No:321, 2nd floor,<br /> Ten square mall, Koyambedu, Chennai - 600107
                    </li>
                    <li className='space-x-3'>
                        <FontAwesomeIcon icon={faPhone} /> <span>044-47796783</span>
                    </li>
                    <li className='space-x-3'>
                        <FontAwesomeIcon icon={faEnvelope} /> <span>044-47796783</span>
                    </li>
                    <div className='flex space-x-5'>
                        <a href="https://www.instagram.com/bonvo_exports?igsh=MXJ2MDc1NGF6MjdheQ==">

                            <FontAwesomeIcon icon={faInstagram} />
                        </a>
                        <a href="https://www.facebook.com/profile.php?id=61557880301331&mibextid=kFxxJD">

                            <FontAwesomeIcon icon={faFacebook} />
                        </a>
                        <a href="http://www.linkedin.com/in/bonvo-exports-69a832302">
